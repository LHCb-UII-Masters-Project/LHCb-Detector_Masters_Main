...
LHCb::Detector::detail::DeTVObject::DeTVObject( const dd4hep::DetElement&             de,
                                                dd4hep::cond::ConditionUpdateContext& ctxt )
    : DeIOVObject( de, ctxt, 1008106 )
    , // matches DetDesc CLID_VeloAlignCond
    sides{{{de.child( "MotionTVLeft" ).child( "TVLeft" ), ctxt, true},
           {de.child( "MotionTVRight" ).child( "TVRight" ), ctxt, false}}} {
  // fill caches
  for ( auto& side : sides ) {
    for ( auto& module : side.modules ) {
      for ( auto& ladder : module.ladders ) {
        ...
        DeTVSensor::getGlobalMatrixDecomposition( sensor, ltg_rot, ltg_trans );
...
LHCb::Detector::detail::DeTVSideObject::DeTVSideObject( const dd4hep::DetElement&             de,
...
LHCb::Detector::detail::DeTVModuleObject::DeTVModuleObject( const dd4hep::DetElement&             de,
                                                            dd4hep::cond::ConditionUpdateContext& ctxt, bool isLeft )
    : DeIOVObject( de, ctxt, 1008106 ) // matches DetDesc CLID_VeloAlignCond
...
LHCb::Detector::detail::DeTVLadderObject::DeTVLadderObject( const dd4hep::DetElement&             de,
                                                            dd4hep::cond::ConditionUpdateContext& ctxt,
                                                            unsigned int moduleId, bool isLeft )
    : DeIOVObject( de, ctxt, 1008106 ) // matches DetDesc CLID_VeloAlignCond
    , sensor{de.child( "sensor" ), ctxt, moduleId, isLeft} {}

int LHCb::Detector::detail::DeTVObject::sensitiveVolumeID( const ROOT::Math::XYZPoint& point ) const {
...
const LHCb::Detector::detail::DeTVModuleObject*
LHCb::Detector::detail::DeTVObject::findModuleFromZ( const double z ) const {
...
void LHCb::Detector::detail::DeTVObject::print( int indent, int flg ) const {
  ...
  dd4hep::printout( dd4hep::INFO, "DeTV", "%s >> Sensors:%ld", prefix.c_str(), detector().path().c_str(),
                    TV::NSensors );
  for ( auto& side : sides ) {
    for ( auto& module : side.modules ) {
