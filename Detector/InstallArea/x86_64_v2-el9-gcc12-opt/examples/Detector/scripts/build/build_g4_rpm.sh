...
../lcgjenkins/LCGRPM/package/createLCGRPMSpec.py -p x86_64-centos7-gcc7-opt --release=1 --match=".*Geant4.*" -o geant4.spec ./LCG_externals_x86_64-centos7-gcc7-opt.txt
rpmbuild -bb geant4.spec
